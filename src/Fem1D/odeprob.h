...
public:
	OdeProb() = default;
	OdeProb(Bndr left, Bndr right, double gamma, std::shared_ptr<util::Fun1D const> const & g, std::shared_ptr<util::Fun1D const> const & f);
	~OdeProb() = default;

	void Define(Bndr left, Bndr right, double gamma, std::shared_ptr<util::Fun1D const> const & g, std::shared_ptr<util::Fun1D const> const & f);
